package com.evan.oa.service.activiti;

import com.evan.oa.ProcessTask.TaskCommand.DeleteActiveTaskCmd;
import com.evan.oa.ProcessTask.TaskCommand.RevokeTaskCmd;
import com.evan.oa.ProcessTask.TaskCommand.StartActivityCmd;
import com.evan.oa.pagination.Page;
import com.evan.oa.service.*;
import com.evan.oa.util.BeanUtils;
import com.evan.oa.entity.*;
...
//    	Context.setProcessEngineConfiguration(defaultProcessEngine.getProcessEngineConfiguration());
	...
	public String startSalaryAdjust(SalaryAdjust salary) throws Exception {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("com.evan.oa.salary", businessKey, variables);
...
//        }
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("com.evan.oa.vacation", businessKey, variables);
        String processInstanceId = processInstance.getId();
	...
	public String startExpense(ExpenseAccount expense) throws Exception {
        ...
        ProcessInstance processInstance = runtimeService.startProcessInstanceByKey("com.evan.oa.expense", businessKey, variables);
        String processInstanceId = processInstance.getId();
