package com.evan.oa.ProcessTask.TaskListener;

import com.evan.oa.entity.UserTask;
import com.evan.oa.service.IUserTaskService;
...
public class UserTaskListener implements TaskListener {
	...
	public void notify(DelegateTask delegateTask) {
		String processDefinitionId = delegateTask.getProcessDefinitionId();	//com.evan.oa.vacation:8:30012
...
//		String processDefinitionName = processDefinition.getName();			//请假流程
		String processDefinitionKey = processDefinition.getKey();			//com.evan.oa.vacation
