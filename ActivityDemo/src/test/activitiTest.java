...
import com.evan.oa.entity.ProcessDefine;
import com.evan.oa.entity.ProcessModel;
		...
		for(Map<String, Object> map : list) {
			...
			for(ProcessDefine proceDef : defineList) {
				...
				for(Map<String, Object> procInstMap : procInstlist) {
					com.evan.oa.entity.ProcessInstance processInstance = (com.evan.oa.entity.ProcessInstance) this.setValToObj(new com.evan.oa.entity.ProcessInstance(), procInstMap);
